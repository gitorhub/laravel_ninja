...
Route::get('/pizzas/create', 'PizzaController@create')->name('pizzas.create'); //altaki ile karışmaması için üste aldık. sadece createte bu gösterilir diğerlerinde alttaki
